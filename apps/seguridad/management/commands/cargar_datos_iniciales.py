...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        permisos_data = [
            ...
            {"modulo": "INVENTARIO", "codigo": "INVENTARIO.STOCK_UBICACIONES.VER",    "nombre": "Ver ubicaciones de stock",         "accion": "VER"},
            {"modulo": "INVENTARIO", "codigo": "INVENTARIO.STOCK_UBICACIONES.EDITAR", "nombre": "Ajustar stock por ubicación",      "accion": "EDITAR"},
